...
The data is scraped from [gutenberg.org](https://www.gutenberg.org/), and processed into CSV format. The processing code can be found in the `R/functions.R` file. 
